...
REM
REM Generated by Vivado on Sun Nov 30 15:28:45 +0800 2025
...
echo "xvlog --incr --relax -prj tb_min_counter_vlog.prj"
call xvlog  --incr --relax -prj tb_min_counter_vlog.prj -log xvlog.log
